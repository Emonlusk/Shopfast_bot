...
def main():
    ...
    with st.sidebar:
        st.markdown("""
            <div style='text-align: center; padding: 1rem;'>
                <h2 style='color: #2196F3;'>ShopFast Assistant</h2>
                <p style='color: #666;'>Your AI Shopping Companion</p>
            </div>
        """, unsafe_allow_html=True)
    ...
    # Main content
    st.markdown("<h1 class='title-text'>ShopFast Customer Support</h1>", unsafe_allow_html=True)
    st.markdown("<p class='subtitle-text'>Your AI shopping assistant is here to help!</p>", unsafe_allow_html=True)
